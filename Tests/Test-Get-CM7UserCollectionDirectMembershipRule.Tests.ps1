# Functional Tests for Get-CM7UserCollectionDirectMembershipRule
# Tests the Get-CM7UserCollectionDirectMembershipRule function behavior and return values
...
BeforeAll {
    ...
    $script:TestDirectMembershipRuleData = $script:TestData['Get-CM7UserCollectionDirectMembershipRule']
...
Describe "Get-CM7UserCollectionDirectMembershipRule Function Tests" -Tag "Integration", "Collection", "Membership" {
    ...
    Context "Test Data Validation" {
        ...
        It "Should have test data defined in declarations.ps1" {
            ...
            $script:TestData.ContainsKey('Get-CM7UserCollectionDirectMembershipRule') | Should -Be $true
        }
        ...
        It "Should output test data for verification" {
            # Output test data
            Write-Host "`n=== Test Data for Get-CM7UserCollectionDirectMembershipRule ===" -ForegroundColor Cyan
    ...
    Context "Connection Requirement" {
        ...
        It "Should fail if not connected to MECM" {
            ...
            # Act & Assert
            { Get-CM7UserCollectionDirectMembershipRule -CollectionName "Test" } | Should -Throw "*not connected*"
    ...
    Context "Query by Collection Name" {
        ...
        It "Should retrieve direct members by collection name" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionName $collectionName
    ...
    Context "Query by Collection ID" {
        ...
        It "Should retrieve direct members by collection ID" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionId $collectionId
    ...
    Context "Query with Resource Name Filter" {
        ...
        It "Should support wildcard in resource name" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionName $collectionName -ResourceName $resourcePattern
        ...
        It "Should return null for non-existent resource name" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionName $collectionName -ResourceName $resourceName
    ...
    Context "Query with Resource ID Filter" {
        ...
        It "Should support resource ID filter" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionId $collectionId -ResourceId $resourceId
    ...
    Context "Fast Parameter" {
        ...
        It "Should return limited properties in Fast mode" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionName $collectionName -Fast
    ...
    Context "Error Handling" {
        ...
        It "Should handle invalid collection ID gracefully" {
            ...
            # Act
            $result = Get-CM7UserCollectionDirectMembershipRule -CollectionId $invalidCollectionId
        ...
        It "Should handle empty results gracefully" {
            ...
            # Act & Assert
            { Get-CM7UserCollectionDirectMembershipRule -CollectionName $collectionName } | Should -Not -Throw
        }
    }
}
