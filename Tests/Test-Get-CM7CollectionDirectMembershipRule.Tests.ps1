# Functional Tests for Get-CM7CollectionDirectMembershipRule
# Tests the Get-CM7CollectionDirectMembershipRule function behavior and return values
...
BeforeAll {
    ...
    $script:TestDirectMembershipRuleData = $script:TestData['Get-CM7CollectionDirectMembershipRule']
...
Describe "Get-CM7CollectionDirectMembershipRule Function Tests" -Tag "Integration", "Collection", "Membership" {
    ...
    Context "Test Data Validation" {
        ...
        It "Should have test data defined in declarations.ps1" {
            ...
            $script:TestData.ContainsKey('Get-CM7CollectionDirectMembershipRule') | Should -Be $true
        }
        ...
        It "Should output test data for verification" {
            # Output test data
            Write-Host "`n=== Test Data for Get-CM7CollectionDirectMembershipRule ===" -ForegroundColor Cyan
    ...
    Context "Connection Requirement" {
        ...
        It "Should fail if not connected to MECM" {
            ...
            # Act & Assert
            { Get-CM7CollectionDirectMembershipRule -CollectionName "Test" } | Should -Throw "*not connected*"
    ...
    Context "Query with Resource Name Filter" {
        ...
        It "Should support wildcard in resource name" {
            ...
            # Act
            $result = Get-CM7CollectionDirectMembershipRule -CollectionName $collectionName -ResourceName $resourcePattern
        ...
        It "Should return null for non-existent resource name" {
            ...
            # Act
            $result = Get-CM7CollectionDirectMembershipRule -CollectionName $collectionName -ResourceName $resourceName
    ...
    Context "Query with Resource ID Filter" {
        ...
        It "Should support resource ID filter" {
            ...
            # Act
            $result = Get-CM7CollectionDirectMembershipRule -CollectionId $collectionId -ResourceId $resourceId
    ...
    Context "Fast Parameter" {
        ...
        It "Should return limited properties in Fast mode" {
            ...
            # Act
            $result = Get-CM7CollectionDirectMembershipRule -CollectionName $collectionName -Fast
    ...
    Context "Error Handling" {
        ...
        It "Should handle invalid collection ID gracefully" {
            ...
            # Act
            $result = Get-CM7CollectionDirectMembershipRule -CollectionId $invalidCollectionId
        ...
        It "Should handle empty results gracefully" {
            ...
            # Act & Assert
            { Get-CM7CollectionDirectMembershipRule -CollectionName $collectionName } | Should -Not -Throw
        }
    }
}
